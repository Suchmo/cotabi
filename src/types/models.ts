...
// docs/screen_design_v5.md のER図(TRIP)に対応。
...
// docs/screen_design_v5.md のER図(SPOT)に対応。
...
// docs/requirements_v6.md のPhase3「ウィッシュリスト」に対応。
...
// docs/screen_design_v5.md のER図(PHOTO)に対応。
